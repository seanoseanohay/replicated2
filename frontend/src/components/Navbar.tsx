    ...
    <header className="bg-gray-900 border-b border-gray-700 shadow-sm">
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-6">
          ...
          >
            Bundle Analyzer <span className="text-xs font-normal text-green-400 ml-1 bg-green-900/30 px-1.5 py-0.5 rounded border border-green-700/50">v{__APP_VERSION__}</span>
          </Link>
          <Link
            to="/dashboard"
